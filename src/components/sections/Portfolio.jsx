...
const DEMO=[
  {id:'p1',title:'E-Commerce',category:'E-Commerce',description:'Tienda online con MercadoPago, stock en tiempo real y panel admin.',long_description:'Tienda online completa con catálogo dinámico, carrito, integración MercadoPago, gestión de stock y notificaciones automáticas a clientes.',tech:['React','Node.js','PostgreSQL','MercadoPago'],url:'ecommerce.krovex.dev',featured:true},
